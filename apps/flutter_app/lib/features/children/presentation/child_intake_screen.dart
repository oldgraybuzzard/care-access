...
/// Multi-step intake form for comprehensive child onboarding
class ChildIntakeScreen extends ConsumerStatefulWidget {
  const ChildIntakeScreen({super.key});

  @override
  ConsumerState<ChildIntakeScreen> createState() => _ChildIntakeScreenState();
}

class _ChildIntakeScreenState extends ConsumerState<ChildIntakeScreen> {
  ...
  final _medicaidIdController = TextEditingController();

  // Step 4: Medical Information
  final _medicationsController = TextEditingController();
  final _allergiesController = TextEditingController();
  final _medicalConditionsController = TextEditingController();
  final _mentalHealthDxController = TextEditingController();

  // Step 5: Behavioral & Trauma
  final _traumaHistoryController = TextEditingController();
  final _attachmentStyleController = TextEditingController();
  ...
  Future<void> _submitIntake() async {
    ...
    try {
      ...
      final data = {
        ...
        'mentalHealthDx': _parseCommaSeparated(_mentalHealthDxController.text),
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(content: Text('Child intake completed successfully')),
        );
        context.pop(true);
      }
    } catch (e) {
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text('Error completing intake: $e'),
